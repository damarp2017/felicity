...
@section('content')
	<header class="w-full overflow-x-hidden bg--blue relative ">
		...
		<div class="mx-4 md:app-container">
			...
			<div class="flex flex-col h-screen justify-center items-center text-center">
				...
				<div class="text-white font-semibold md:mb-5 text-5xl md:line--height-97 md:font--size-100">Our Capabilities</div>
	...
	<section class="bg-white w-full overflow-x-hidden py-10 md:py-20">
		<div class="mx-4 md:app-container">
			<div class="block md:flex md:h-screen-3/4 justify-between items-center mb-20 ">
				<div class="block md:hidden w-full md:w-1/2 "><img class="h-auto  md:h-96" src="{{ asset('images/capabilities/branding.png') }}"></div>
				<div class="w-full md:w-1/2 ">
					<div class="text-5xl md:font--size-70 font-bold mb-4 md:mb--23">Branding</div>
			...
			<div class="block md:flex md:h-screen-3/4 justify-between items-center mb-20">
				...
				<div class="w-full md:w-1/2">
					<div class="text-5xl md:font--size-70 font-bold mb-4 md:mb--23">
						<div>Marketing</div>
			...
			<div class="block md:flex md:h-screen-3/4 justify-between items-center">
