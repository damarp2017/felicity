	...
	<section class="bg-white w-full overflow-x-hidden py-20 md:py-32">
		<div class="mx-4 md:mx-36">
			<div class="mb-10 md:mb-24">
				...
				<div class="text-gray-400 text--typography mb-8 text-base md:font--size-17">Engineering technologies that bring people together in the real world is both inspiring and daunting. We're tackling challenges in search relevance, payments, fraud prevention, discrimination, and growth—all while maintaining a beautiful expe Engineering technologies that bring people together in the real world is both inspiring and daunting. We're tackling challenges in search relevance, payments, fraud prevention, discrimination, and growth—all while maintaining a beautiful expe</div>
			...
			<div class="flex flex-col md:flex-row items-center gap-y-10 md:gap-y-0 gap-x-0 md:gap-x-14 mb-10">
				<div class="w-full md:w-auto">
					<div class="text-md md:font--size-14 uppercase text-gray-400">ADDRESS</div>
					<div class="text-md md:font--size-19 text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
				</div>
				<div class="w-full md:w-auto">
					<div class="text-md md:font--size-14 uppercase text-gray-400">PHONE</div>
					<div class="text-md md:font--size-19 text-gray-500">+91 91 2345678</div>
				</div>
				<div class="w-full md:w-auto">
					<div class="text-md md:font--size-14 uppercase text-gray-400">EMAIL</div>
					<div class="text-md md:font--size-19 text-gray-500">+91 91 2345678</div>
				</div>
			</div>
				...
				<div class="block md:flex items-stretch gap-x-7">
					...
					<div class="w-full md:w-1/2">
						<form action="">
							...
							<button class="w-full py-3 text-white text-center md:font--size-21 rounded-lg bg--pink">Send</button>
						</form>
					</div>
