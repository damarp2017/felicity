    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->routeIs('backoffice.subscriber.list.*') ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link {{ request()->routeIs('backoffice.subscriber.list.*') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-home"></i>
                        <p>
                            Reports
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('backoffice.subscriber.list') }}"
                                class="nav-link {{ request()->routeIs('backoffice.subscriber.list') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Subscribers</p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('backoffice.contact.list') }}"
                                class="nav-link {{ request()->routeIs('backoffice.contact.list') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Contact Us</p>
                            </a>
                        </li>
