                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a
                                href="{{ route('backoffice.setting') }}">Edit Our Process</a></li>
                        {{-- <li class="breadcrumb-item"><a
			...
			<div class="col-md-9">
				<div class="card ">
					<div class="card-header">
						<h3 class="card-title">Edit Our Process</h3>
					</div>
					<form action="{{ route('backoffice.dynamic.our.process.edit', [$capabilityId, $data->id]) }}" method="post">
						@method('put')
						@csrf
						<div class="card-body">
