        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Join The Team</h3>
                </div>
                <form action="{{ route('backoffice.section.join.the.team') }}" method="post">
                    @method('put')
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="text_button" name="text_button" required
                                placeholder="Enter Text Button" value="{{ old('text_button') ?? ($data ? $data->text_button : '') }}">
                        </div>
                        <div class="form-group">
                            <label for="link_button">Link Button</label>
                            <input type="text" class="form-control" id="link_button" name="link_button" required
                                placeholder="Enter Link Button" value="{{ old('link_button') ?? ($data ? $data->link_button : '') }}">
                        </div>
                    </div>
