		...
		<div class="col-md-12">
			...
			<div class="card card-success">
				<div class="card-header">
					<h3 class="card-title">Edit Location : {{ $location->city }}</h3>
				</div>
				<form action="{{ route('backoffice.static.location.edit', $location->id) }}" method="post">
					@method('put')
					@csrf
					<div class="card-body">
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="city" name="city" required
										placeholder="Enter city" value="{{ old('city') ?? $location->city }}">
								</div>
								<div class="form-group">
									<label for="address">Address</label>
									<textarea name="address" id="address" class="form-control" cols="30" rows="10"
										placeholder="Enter Address" required>{{ old('address') ?? $location->city }}</textarea>
								</div>
							</div>
							<div class="col-md-8">
