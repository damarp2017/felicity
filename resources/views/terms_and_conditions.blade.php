	...
	<section class="bg-white w-full overflow-x-hidden py-20 md:py-32">
		<div class="mx-4 md:mx-36">
			<div class="mb-10">
				...
				<div class="text-gray-400 text-base md:font--size-18">for world-class brands to make your products to live for world-class brands to make your products to live for world-class brands to make your products to</div>
			</div>

			<div>
				@for ($i = 0; $i < 2; $i++)
					<div class="text-gray-400 text-md mb-10 md:font--size-18">
