	...
	<section class="bg-white w-full overflow-x-hidden pt-10 md:pt-36">
		<div class="mx-4 md:mx-36">
			<div class="block md:flex mb-10 flex-col">
				<div class="mb-6 text-4xl md:text-7xl font-semibold">Vision</div>
			...
			<div class="block md:flex mb-10 md:mb-24 items-center">
				...
				<div class="w-full md:w-1/2">
					<div class="mb-3 text-black ">
						...
						<div class="text-5xl md:text-7xl font-bold">For Company</div>
					</div>
			...
			<div class="block md:flex mb-10 md:mb-24 items-center">
				...
				<div class="w-full md:w-1/2">
					<div class="mb-3 text-black ">
						...
						<div class="text-5xl md:text-7xl font-bold">For Team</div>
					</div>
					<div class="text-base md:text-xl text--grey-transparent mb-4">The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.</div>
				</div>
			...
			<div class="block md:flex mb-24 items-center">
				...
				<div class="w-full md:w-1/2">
					<div class="mb-3 text-black ">
						...
						<div class="text-5xl md:text-7xl font-bold">Vision</div>
					</div>
					<div class="text-base md:text-xl text--grey-transparent mb-4">The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.</div>
				</div>
			</div>
			...
			<div class="block md:flex mb-24 items-center">
				...
				<div class="w-full md:w-1/2">
					<div class="mb-3 text-black ">
						...
						<div class=" text-5xl md:text-7xl font-bold">Conscious Advertising Network</div>
					</div>
					<div class="text-base md:text-xl text--grey-transparent mb-4">The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.</div>
				</div>
				<div class="hidden md:block w-full md:w-1/2">
			...
			<div class="block md:flex mb-24 items-center">
				...
				<div class="w-full md:w-1/2">
					<div class="mb-3 text-black ">
						...
						<div class="text-5xl md:text-7xl font-bold">Mentored By Schbang</div>
					</div>
					<div class="text-base md:text-xl text--grey-transparent mb-4">The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.The sketching of wireframes is integral in beginning to realise concepts and ideas into readable, managed design.</div>
				</div>
			</div>
