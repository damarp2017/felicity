	...
	<header class="w-full overflow-x-hidden bg--blue relative">
		...
		<div class="mx-4 md:app-container">
			...
			<div class="flex flex-col h-full justify-center items-center text-center" style="padding: 20% 0">
				...
				<div class="text-base md:font--size-20 text-white opacity-50 w-3/4">It is our constant endeavour to help businesses grow and evolve over time and to be able to achieve it, we want to work with people that synergise with the values that we strongly imbibe in every thing we do here at Felicity</div>
			</div>
		</div>
	</header>
	...
	<!-- <section class="bg-white w-full overflow-x-hidden py-10 md:pb-20 md:pt--137">
		<div class="mx-4 md:app-container">
			<div class="block md:flex mb-10 flex-col">
				...
				<div class="text-base md:font--size-20 line--height-160 " style="color: #898989">Our vision is to take India to the world - capture its culture, its people, its expertise, and its diversity to enable other markets to enrich and inculcate Indian values; to make India a front-runner in advertising.</div>
			</div>
		</div>
	</section> -->
		...
		<div class="mx-4 md:app-container">
			<div class="block md:flex mb-24 items-center">
				...
				<div class="w-full md:w--549">
					...
					<div class="text-base md:font--size-20 line--height-160 text--gray mb-4">The Conscious Advertising Network is a voluntary coalition of over 70 organisations set up to ensure that industry ethics catches up with the technology of modern advertising.</div>
				</div>
