	...
	<div class="mx-4 md:app-container">
		<div class="{{ request()->is('/') ? 'md:ml--24' : '' }}">
			<div class="mb--62">
				...
				<div class="font--poppins mb-4 md:mb-7 md:font--size-17" style="color: #8C8C8C; line-height: 31px;">{{ $footer ? $footer->subtitle : '' }}</div>
			...
			<div class="grid grid-cols-2 md:flex md:flex-row mb--94">
				...
				<div class="flex flex-col mb-8 md:mb-0">
					...
					<a href="{{ route('terms.index') }}" class="text-white mb-2 md:font--size-18 font--poppins">Terms</a>
					<a href="{{ route('privacy.index') }}" class="text-white mb-2 md:font--size-18 font--poppins">Privacy</a>
