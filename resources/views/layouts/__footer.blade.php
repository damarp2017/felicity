	...
	<div class="mx-4 md:mx-36">
		...
		<div class="grid grid-cols-2 md:grid-cols-3 gap-x-5 md:gap-x-28 mb-6 md:mb-20 ">
			<div class="flex flex-col mb-8 md:mb-0">
				<div class="text-gray-50 font--poppins mb-2 md:font--size-17 font--poppins uppercase">quick links</div>
			...
			<div class="flex flex-col mb-8 md:mb-0">
				<div class="text-gray-50 mb-2 md:font--size-17 font--poppins uppercase">Social Media</div>
			...
			<div class="flex flex-col mb-8 md:mb-0">
				<div class="text-gray-50 mb-2 md:font--size-17 font--poppins uppercase">About</div>
