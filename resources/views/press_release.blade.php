...
@section('content')
	...
	<section class="bg-white w-full overflow-x-hidden py-20 md:py-32">
		<div class="mx-4 md:mx-36">
			<div class="mb-24">
				<div class="mb-3 font-semibold text-3xl md:font--size-65">Press Release</div>
			...
			@for ($i = 0; $i < 4; $i++)
				<div class="mb-10 md:mb-24">
					...
					<div class="text-gray-500 mb-5 md:font--size-17">A world where anyone can belong anywhere starts with a workplace where you feel welcome and can contribute your best work. Airbnb welcomes candidates with backgrounds that are traditionally underrepresented in tech and offers opportunities to create community in our offices around the world.</div>
					<hr>
				</div>
			@endfor
		</div>
