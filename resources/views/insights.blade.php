...
@section('content')
	<header class="w-full overflow-x-hidden bg--blue relative " >
		...
		<div class="flex flex-col h-full justify-center items-center" style="padding: 23% 0">
			...
			<div class="text-base md:font--size-20 text-center w-9/12 md:w-full md:text-lg text-white opacity-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis diam elementum <br> arcu eu cras egestas ac adipiscing. Et arcu, elementum molestie sed bland</div>
		</div>
	</header>
