		...
		<div class="mx-4 md:app-container">
			<div class="flex flex-col md:flex-row gap-y-10 md:gap-y-0 gap-x-0 md:gap-x-10 mb-10">
				...
				<div class="w-full md:w-1/2">
					...
					<div class="text-md text-gray-400 text--typography md:font--size-18">
			...
			<div class="text-gray-400 text--typography md:font--size-18 mb-10">
			...
			<div>
				<div class="flex items-center gap-x-4 mb-10">
					<div class="font-semibold text-2xl md:font--size-30">Comments</div>
					<div class="text-lg text-gray-400 md:font--size-22">24</div>
					...
					<div class="mb-10">
						@for ($i = 0; $i < 4; $i++)
							<div class="flex gap-x-3 items-center mb-7">
								...
								<div>
									<div class="font-semibold text-lg md:font--size-21">Jenie Asman</div>
									<div class="text-gray-400 text-sm md:font--size-13">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa pulvinar pretium morbi eu, eu aliquam.</div>
								</div>
							</div>
						@endfor
					</div>
