		...
		<div class="mx-4 md:container--other-layouts">
			<div class="flex flex-col md:flex-row gap-y-10 md:gap-y-0 gap-x-0 mb-10">
				<div class="w-full md:w-1/2 md:mr--78">
					<img class="w-full rounded object-cover object-center md:h-full"  src="{{ asset('images/capabilities_2/1.png') }}" alt="">
				</div>
				<div class="w-full md:w-1/2">
					<div class="text-md ml-5 uppercase mb-5 md:font--size-13 font--gilroy-md" style="letter-spacing: 0.08em;">color design</div>
			...
			<div class="flex gap-x-7 items-center mb-20">
				<div class=" block md:hidden bg-blue-700 w-20 h-20 rounded-full p-3 ">
					<div class="flex justify-center mb-2">
						<img class="w-8 h-8" src="{{ asset('images/utilities/slap.png') }}" alt="">
					</div>
					<div class="text-white text-center">236</div>
				</div>
				<img class="hidden md:block mr--36" src="{{ asset('images/utilities/applause.png') }}" alt="">

				<div class=" h-12 w-12 md:w--68 md:h--68 p-3 md:mr--36 rounded-full flex justify-center items-center"
			...
			<div>
				<div class="flex items-center mb-10">
					...
					w--135 h--39 inline-block text-center font--sf-pro-display">
						read all
					</button>
				</div>
				<div class="w-full md:w-1/2">
					<div class="mb-10">
						@for ($i = 0; $i < 4; $i++)
							<div class="flex gap-x-3 items-center mb-7">
								...
								<div>
									<div class="text-lg md:font--size-21">Jenie Asman</div>
									<div class=" text-sm md:font--size-13 font--sf-pro-display" 
									style="color: #AAAAAA">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa pulvinar pretium morbi eu, eu aliquam.</div>
								</div>
							</div>
						@endfor
					</div>
					...
					<div>
						<input type="text" class="bg-gray-100 font--gilroy-md md:font--size-15 placeholder-black w-full px-4 py-3 md:px--26 md:py--21 rounded-xl outline-none focus:outline-none" placeholder="Add Comment">
					</div>
				</div>
			</div>
		</div>
