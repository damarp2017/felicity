...
@section('content')
	<header class="w-full overflow-x-hidden bg--header-gradient relative height--header">
		...
		<div class="flex flex-col h-full justify-center items-center">
			<div class="mx-4 md:mx-0  text-center">
				<div class="text-white font-semibold text-6xl md:text-8xl mb-5 text-center"> Branding at it’s <br> best at Felicity</div>
			</div>
			<div class="block text-center md:hidden text-lg md:text-2xl text-white mb-3 uppercase md:normal-case">that next <span class="font-normal md:font-semibold not-italic md:italic">generation</span> will witness</div>
			<div class="text-base text-center md:text-xl w-9/12 md:w-full text-white opacity-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis diam elementum <br> arcu eu cras egestas ac adipiscing. Et arcu, elementum molestie sed bland</div>
		</div>
	</header>
	...
	<section class="bg--gray-light w-full overflow-x-hidden pt-10 md:py-28">
		<div class="mx-4 md:mx-36">
			<div class="flex items-center mb-20">
				...
				<div class="text--pink text-3xl md:text-7xl font-bold">Our Process</div>
			</div>
			...
			<div class="block md:flex mb-24">
				...
				<div class="w-full md:w-1/2">
					<div class="mb-3 text-black ">
						...
						<div class="text-5xl md:text-7xl font-bold">Brainstroming</div>
					</div>
	...
	<section class="bg-white w-full overflow-x-hidden pt-10 md:pt-36">
		<div class="mx-4 md:mx-36">
			<div class="block md:flex mb-10 flex-col">
				<div class="mb-6 text-3xl md:text-7xl font-semibold">What’s all Included</div>
				<div class="text-base md:text-xl text--grey-transparent">for world-class brands to make your products to live for world-class brands to make your products to live for world-class brands to make your products to</div>
			</div>
		</div>

		<div class="relative mx-10">
			<div class="mx-0 md:mx-10">
				<div class="block gap-x-10">
					<div class="border-b md:border-r border-gray-200 px-5 py-10">
	...
	<section  class="bg-white w-full overflow-x-hidden py-10 md:pt-36">
		<div class="mx-4 md:mx-36">
			<div class="w-3/4 mb-10">
				<div class="text-3xl md:text-7xl font-semibold mb-4">Work with us for a <span class="text--pink">Project ?</span></div>
