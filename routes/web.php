...
Route::prefix('backoffice')->middleware('auth')->group(function () {
    ...
    Route::prefix('reports')->group(function () {
        Route::prefix('subscribers')->group(function () {
            Route::get('list', [SubscriberController::class, 'list'])->name('backoffice.subscriber.list');
        });

        Route::prefix('contacts')->group(function () {
            Route::get('list', [ContactUsController::class, 'list'])->name('backoffice.contact.list');
        });
    });
